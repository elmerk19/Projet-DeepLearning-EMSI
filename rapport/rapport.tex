...
% --- PAGE DE GARDE PROFESSIONNELLE (COMMENCE DIRECTEMENT ICI) ---
\begin{titlepage}
...
\begin{center}
{\Large \textbf{Ecole Marocaine des Sciences de l'Ingénieur}}\\[1.2cm]

\rule{\linewidth}{0.5mm}\\[0.4cm]
{\Huge \bfseries Conception, implémentation, comparaison et analyse critique de modèles de
deep learning pour données tabulaires, images et séquences}\\[0.5cm]
\rule{\linewidth}{0.3mm}\\[2cm]

{\large Projet académique}\\
{\large Module : Deep Learning}
\end{center}
\vfill
\noindent
\textbf{Réalisé par :}\\KIMATH Elmer\\

\textbf{Encadré par :} Mme.HIDILA Zineb\\

\textbf{Filiere : 4IADA/2025--2026}
